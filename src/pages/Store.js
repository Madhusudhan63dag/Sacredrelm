...
const Store = () => {
    ...
    return (
        <div className="bg-[#faebd7] min-h-screen">
            <Helmet>
                <title>Shop Spiritual Items – Sacred Relm Store</title>
                <meta name="description" content="Browse our premium collection of spiritual products, idols, yantras, and sacred artifacts. Fast delivery across India." />
