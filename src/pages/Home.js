...
const Home = () => {
    ...
    return (
        <div className="overflow-hidden">
            <Helmet>
                <title>Sacred Relm – Premium Spiritual Items & Artifacts</title>
                <meta name="description" content="Shop authentic spiritual items, handcrafted idols, sacred yantras, and religious artifacts. Fast delivery across India." />
                <link rel="canonical" href={SITE_URL} />
                <meta property="og:title" content="Sacred Relm – Premium Spiritual Items & Artifacts" />
