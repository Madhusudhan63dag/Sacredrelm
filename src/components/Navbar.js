          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <img 
                src={logo} 
                alt="Brand Logo" 
                className="h-20 md:h-24 transition-transform duration-300 group-hover:scale-105" 
              />
            </Link>
            ...
            <nav className="hidden md:flex items-center text-xl space-x-10">
              <div className='flex items-center justify-center flex-col'>
                <Link to="/" className="nav-link font-medium flex items-center justify-center flex-row text-gray-800 hover:text-[#DA9687] transition-all duration-300 relative after:absolute after:bottom-[-6px] after:left-0 after:h-[2px] after:w-0 after:bg-[#DA9687] after:transition-all hover:after:w-full">
                  <img src={icons} alt="Icons" className="h-8 w-8" />
                    Home
                </Link>
              </div>
              <div className='flex items-center justify-center flex-col'>
                <Link to="/shop" className="nav-link font-medium flex items-center justify-center flex-row text-gray-800 hover:text-[#DA9687] transition-all duration-300 relative after:absolute after:bottom-[-6px] after:left-0 after:h-[2px] after:w-0 after:bg-[#DA9687] after:transition-all hover:after:w-full">
              ...
              <div className='flex items-center justify-center flex-col'>
                <Link to="/contact" className="nav-link font-medium flex items-center justify-center flex-row text-gray-800 hover:text-[#DA9687] transition-all duration-300 relative after:absolute after:bottom-[-6px] after:left-0 after:h-[2px] after:w-0 after:bg-[#DA9687] after:transition-all hover:after:w-full">
