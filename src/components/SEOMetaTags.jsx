 ...
 */
export const ProductSEO = ({ product, siteUrl = 'https://sacredrelm.com' }) => {
 ...
 */
export const CategorySEO = ({ categoryName, products = [], siteUrl = 'https://sacredrelm.com' }) => {
 ...
 */
export const HomeSEO = ({ siteUrl = 'https://sacredrelm.com' }) => {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Organization",
    "name": "Sacred Collection",
